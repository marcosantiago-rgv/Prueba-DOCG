...
class CredencialesDeUsuarios(db.Model, BaseMixin):
    ...
    id_usuario = db.Column(db.UUID, db.ForeignKey(
    ...
    usuario = db.relationship(
        "Usuarios", backref="credenciales_de_usuarios", lazy=True)
...
class Reportes(db.Model, BaseMixin, AuditMixin):
    id_categoria_de_reporte = db.Column(db.UUID, db.ForeignKey(
        'categorias_de_reportes.id'), nullable=False)
    ...
    categoria = db.relationship(
        "CategoriasDeReportes", backref="reportes", lazy=True)
