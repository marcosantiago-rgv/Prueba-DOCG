...
def get_non_edit_status():
    status=['Cancelado','Cancelada','Recibida','Finalizada','Entregada','Realizada','Realizado','Pagado','Pagado parcial','Aprobada','Aprobado','Recibida parcial','Pagado parcial','En proceso']
    return status
